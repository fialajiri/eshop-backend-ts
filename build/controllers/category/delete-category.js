...
var deleteCategory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var categoryId, category, err_1, session, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                return [4 /*yield*/, category.remove({ session: session })];
            case 7:
                _a.sent();
                return [4 /*yield*/, product_1.Product.updateMany({ _id: category.products }, { $pull: { categories: category._id } }, { session: session })];
            case 8:
                _a.sent();
