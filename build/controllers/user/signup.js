...
var signUp = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, err_1, newUser, payload, userJwt;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                if (existingUser) {
                    throw new bad_request_error_1.BadRequestError("Uživatel s tímto emailem již existuje. Zkuste se přihlásit");
                }
            ...
            case 5:
                ...
                userJwt = jwt_1.jwtService.getToken(payload);
                req.session = {
                    jwt: userJwt,
                };
