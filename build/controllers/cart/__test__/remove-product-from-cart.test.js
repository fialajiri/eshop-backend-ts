    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                        .put("/api/cart/removefromcart/".concat(cart.id))
                        .send({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                        .put("/api/cart/removefromcart/".concat(nonExistentCartId))
                        .send({
                        productId: product1.id,
                    })
                        .expect(404)];
...
it("removes the product from the cart and restores the availability", function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, product1, cart, updatedCart, updatedProduct;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, setup()];
            case 1:
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                        .get("/api/products/".concat(product1.id))
                        .expect(200)];
            case 3:
