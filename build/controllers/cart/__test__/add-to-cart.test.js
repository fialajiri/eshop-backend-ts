...
var setup = function () { return __awaiter(void 0, void 0, void 0, function () {
    var category, product, product2, cart;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent();
                return [2 /*return*/, { product: product, cart: cart, product2: product2 }];
        }
    });
}); };
...
it("returns a 400 if the quantity exceed the quantity in stock", function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, product, cart;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, setup()];
            case 1:
                _a = _b.sent(), product = _a.product, cart = _a.cart;
                return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                        .put("/api/cart/addtocart/".concat(cart.id))
                        .send({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                        .put("/api/cart/addtocart/".concat(nonExistentCartId))
                        .send({
                        productId: product.id,
                        quantity: 1,
                    })
...
it("add a new item to the cart", function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, product, cart, product2, updatedCart;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, setup()];
            case 1:
                _a = _b.sent(), product = _a.product, cart = _a.cart, product2 = _a.product2;
                return [4 /*yield*/, (0, supertest_1.default)(app_1.app)
                        .put("/api/cart/addtocart/".concat(cart.id))
                        .send({
...
it("increse the quantity of existing item", function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, product, cart, updatedCart;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, setup()];
            case 1:
