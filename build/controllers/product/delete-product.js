...
var deleteProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, product, err_1, session, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                _a.sent();
                return [4 /*yield*/, product.remove({ session: session })];
            case 8:
                _a.sent();
            ...
            case 10:
                err_2 = _a.sent();
                throw new database_connection_error_1.DatabaseConnectionError("Nepodařilo se smazat produkt");
            case 11:
                session.endSession();
                return [7 /*endfinally*/];
