...
var getProducts = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var pageSize, page, keyword, categoryId, category, count, products, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, category_1.Category.findById(req.query.categoryId)];
            case 1:
                category = _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, product_1.Product.count(__assign(__assign({}, keyword), categoryId))];
            case 3:
                count = _a.sent();
                return [4 /*yield*/, product_1.Product.find(__assign(__assign({}, keyword), categoryId))
