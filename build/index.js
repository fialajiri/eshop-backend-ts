...
var mongoDbUrl = "mongodb+srv://".concat(process.env.DB_USER, ":").concat(process.env.DB_PASSWORD, "@cluster0.oahmw.mongodb.net/").concat(process.env.DB_NAME, "?retryWrites=true&w=majority");
