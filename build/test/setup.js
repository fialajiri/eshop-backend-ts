    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mongodb_memory_server_1.MongoMemoryReplSet.create({ replSet: { storageEngine: 'wiredTiger' } })];
            case 1:
...
afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, replset.cleanup()];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
global.signin = function (isAdmin, userId) {
    // Build a JWT payload.  { id, email }
    var payload = {
        id: userId || new mongoose_1.default.Types.ObjectId().toHexString(),
        email: 'test@test.com',
        isAdmin: isAdmin
    };
    // Create the JWT!
    var token = jwt_1.jwtService.getToken(payload);
